package cn.xzxy.lewy.basic.futurn;
...
/**
 * 测试 JDK-Future / Netty-Future / Netty-Promise 效果
 */
public class FutureTest {
    ...
    public static void nettyFuture() {
        ...
        io.netty.util.concurrent.Future<String> task = eventLoop.submit(() -> "我是Netty-Future任务.....");

        // 添加一个异步任务执行完成之后的回调方法
        task.addListener(listenerTask -> System.out.println(listenerTask.getNow()));
